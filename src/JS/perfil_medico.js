    ...
    if (doctorId) {
        const doctorData = {
            ...
            'lic-ana-corina-ballesteros': {
                ...
                prices: 'Consulta en línea: $800<br>Consulta presencial: $1000',
                experience: 'Más de 15 años de experiencia en cardiología. Experta en tratamiento de enfermedades cardiovasculares y prevención de ataques al corazón. Ha trabajado en prestigiosos hospitales y clínicas.',
                opinions: ['Excelente doctora, muy profesional.', 'Muy atenta y amable.', 'Su diagnóstico salvó mi vida.'],
                clinics: [
                    { address: 'Calle El Vergel 239, Querétaro', mapLink: 'https://goo.gl/maps/example1' },
                    { address: 'Calle Falsa 456, Querétaro', mapLink: 'https://goo.gl/maps/example2' }
                ]
            ...
            'lic-valeria-slusar': {
                ...
                experience: 'Más de 10 años de experiencia en psicología. Especializada en terapia cognitivo-conductual y tratamiento de ansiedad y depresión. Ofrece sesiones individuales y grupales.',
                opinions: ['Muy comprensiva y profesional.', 'Gran capacidad de escucha.', 'Me ha ayudado mucho con mi ansiedad.'],
                clinics: [
            ...
            'dr-maritza-sandoval-rincon': {
                ...
                experience: 'Más de 15 años de experiencia en psiquiatría. Especializada en el tratamiento de trastornos mentales graves. Ha publicado varios artículos en revistas médicas.',
                opinions: ['Muy profesional y atenta.', 'Excelente trato.', 'Su tratamiento ha mejorado mi vida significativamente.'],
                clinics: [
            ...
            'mtra-mariela-eula': {
                ...
                specialty: 'Complementary Therapist',
                ...
                experience: 'Más de 5 años de experiencia en terapia complementaria. Utiliza métodos holísticos para tratar el estrés y la ansiedad. Ofrece terapias personalizadas y talleres grupales.',
                opinions: ['Muy buena atención.', 'Recomendada.', 'Sus terapias son muy efectivas.'],
                clinics: [
