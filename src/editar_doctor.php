"este es la de editar en perfil doctor ya sirve pero pruebalo "
...
$sql = "SELECT u.nombre, u.apellido, u.telefono, u.correo, u.fecha_nacimiento, u.direccion, u.id_estado, u.id_ciudad, u.id_genero, d.id_especialidad, u.avatar,
        DATE_FORMAT(u.ultimo_ingreso, '%d/%b/%Y %r') AS ultimo_ingreso, e.nombre AS estado, c.nombre AS ciudad, g.genero AS genero 
        FROM usuarios u 
        ...
        LEFT JOIN medico d ON u.id_usuario = d.id_usuario 
        WHERE u.correo = ?";
...
if ($result->num_rows > 0) {
    ...
    $avatar = isset($usuario['avatar']) ? $usuario['avatar'] : 'imagenes/avatar.png';
} else {
...
<head>
    ...
    <link rel="stylesheet" href="CSS/editar_doctor.css">
...
<body>
            ...
            <div class="header-container">
                ...
                <ul class="nav-menu">
                    <li class="nav-menu-item">
                        <a href="inicio_medico.php" class="nav-menu-link nav-link">Inicio</a>
                    </li>
    ...
    <div class="main-container">
        <div class="profile-section">
            <h1>Editar Doctor</h1>
            <form action="actualizar_doctor.php" method="post" enctype="multipart/form-data">
                ...
                <div class="form-section">
                    ...
                    <select name="especialidad" id="especialidad" required>
                        <?php while ($row_especialidad = $result_especialidades->fetch_assoc()): ?>
                            <option value="<?php echo $row_especialidad['id_especialidad']; ?>" <?php echo $id_especialidad == $row_especialidad['id_especialidad'] ? 'selected' : ''; ?>>
                                <?php echo $row_especialidad['nombre']; ?>
                            </option>
                        <?php endwhile; ?>
                    </select>
                </div>
